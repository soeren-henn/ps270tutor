...
- Use the `str` function on the `star` to see what the structure of the data looks like. You can always use the `head` function to view the first six rows of the data set.
...
Both of these return `NA` because they are saying we can't tell if the statement is true or not: the truth of the statement is unknown. This leads to head-scratchers like this:
