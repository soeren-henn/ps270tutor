...
Sometimes we need to create new variables that are transformation or mutations of existing variables. This is where the `mutate()` function comes in. This allows us to create new variables based on existing ones with the following syntax:
